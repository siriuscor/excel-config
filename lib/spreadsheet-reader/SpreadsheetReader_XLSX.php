 ...
 */
	class SpreadsheetReader_XLSX implements Iterator, Countable
	{
		...
		{
			if (!is_numeric($Index)) {
				return $this->ChangeSheetByName($Index);
			}
		...
		public function ChangeSheetByName($name)
		{
			...
			// var_dump($name);
			$RealSheetIndex = array_search($name, $this->Sheets);
